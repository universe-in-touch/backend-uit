...
// functions/connect-order.ts
var connect_order_exports = {};
__export(connect_order_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(connect_order_exports);
...
var handler = async (event, context) => {
  console.log("\u{1F4E9} \u0417\u0430\u043F\u0440\u043E\u0441 \u043D\u0430 \u0441\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u043E\u0440\u0434\u0435\u0440\u0430...");
  try {
    const params = event.queryStringParameters;
    const xrpPay = Math.round(parseFloat(params?.xrpPay || "0") * 1e6);
    const babaGet = parseFloat(params?.babaGet || "0");
    const refCode = params?.refCode || "";
    console.log("\u{1F50D} \u041F\u043E\u043B\u0443\u0447\u0435\u043D\u043D\u044B\u0435 \u043F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B:", { xrpPay, babaGet, refCode });
    ...
    console.log("\u{1F6E0} \u0413\u0435\u043D\u0435\u0440\u0430\u0446\u0438\u044F XUMM payload \u0434\u043B\u044F \u043E\u0440\u0434\u0435\u0440\u0430...");
    const payload = await xumm.payload.create({
      TransactionType: "OfferCreate",
      Fee: "12",
      TakerPays: {
        currency: "4241424100000000000000000000000000000000",
        // 40-байтовый хеш валюты (BABA)
...
//# sourceMappingURL=connect-order.js.map
