...
// node_modules/fetch-ponyfill/node_modules/node-fetch/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/fetch-ponyfill/node_modules/node-fetch/lib/index.js"(exports2, module2) {
    "use strict";
...
var require_fetch_node = __commonJS({
  "node_modules/fetch-ponyfill/fetch-node.js"(exports2, module2) {
    "use strict";
...
var require_main = __commonJS({
  "node_modules/os-browserify/main.js"(exports2, module2) {
...
var require_utils2 = __commonJS({
  "node_modules/xumm-sdk/dist/src/utils.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DeferredPromise = exports2.throwIfError = void 0;
...
var require_Meta = __commonJS({
  "node_modules/xumm-sdk/dist/src/Meta.js"(exports2) {
    "use strict";
    ...
    var Meta = class {
      constructor(apiKey2, apiSecret2) {
        ...
        if (secret.split.length === 3 && secret.split.slice(0, 2).join(":") === "xApp:OneTimeToken") {
          ...
          secret.uuidv4 = apiSecret2;
        }
        if (!uuidRe.test(apiKey2) || !uuidRe.test(secret.uuidv4)) {
          if (!this.jwtFlow) {
...
var require_Storage = __commonJS({
  "node_modules/xumm-sdk/dist/src/Storage.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
var require_Payload = __commonJS({
  "node_modules/xumm-sdk/dist/src/Payload.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
var require_JwtUserdata = __commonJS({
  "node_modules/xumm-sdk/dist/src/JwtUserdata.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    exports2.JwtUserdata = JwtUserdata;
  }
});

// node_modules/xumm-sdk/dist/src/xApp.js
var require_xApp = __commonJS({
  "node_modules/xumm-sdk/dist/src/xApp.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
var require_Push = __commonJS({
  "node_modules/xumm-sdk/dist/src/Push.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
var require_src3 = __commonJS({
  "node_modules/xumm-sdk/dist/src/index.js"(exports2) {
    "use strict";
    var __awaiter = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.XummSdkJwt = exports2.XummSdk = void 0;
    var debug_1 = require_src();
    ...
    var XummSdk2 = class {
      constructor(apiKey2, apiSecret2) {
        log("Constructed");
        this.Meta = new Meta_1.Meta(apiKey2 || this.getEnv("XUMM_APIKEY"), apiSecret2 || this.getEnv("XUMM_APISECRET"));
    ...
    exports2.XummSdk = XummSdk2;
    var XummSdkJwt = class extends XummSdk2 {
    ...
    exports2.XummSdkJwt = XummSdkJwt;
  }
});
...
// functions/connect-trustline.ts
var connect_trustline_exports = {};
__export(connect_trustline_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(connect_trustline_exports);
var import_xumm_sdk = __toESM(require_src3(), 1);
var dotenv = __toESM(require_main2(), 1);
dotenv.config();
var apiKey = process.env.XUMM_API_KEY;
var apiSecret = process.env.XUMM_API_SECRET;
var xumm = new import_xumm_sdk.XummSdk(apiKey, apiSecret);
var handler = async (event, context) => {
  console.log("\u{1F4E9} \u0417\u0430\u043F\u0440\u043E\u0441 \u043D\u0430 \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 Trustline...");
  try {
    console.log("\u{1F6E0} \u0413\u0435\u043D\u0435\u0440\u0430\u0446\u0438\u044F XUMM payload...");
    ...
    const response = {
      ...
      headers: {
        ...
        // Разрешает CORS-запросы
        "Access-Control-Allow-Headers": "Content-Type",
        // Исправление, добавление обязательных заголовков
        "Access-Control-Allow-Methods": "GET, POST, OPTIONS"
        // Добавление разрешенных методов
      },
      body: JSON.stringify({ uuid: payload.uuid })
      // Отправляем только uuid
    };
    return response;
  } catch (error) {
    ...
    const errorResponse = {
      ...
      headers: {
        "Access-Control-Allow-Origin": "*"
        // Добавление корректных заголовков для ошибки
      },
...
//# sourceMappingURL=connect-trustline.js.map
