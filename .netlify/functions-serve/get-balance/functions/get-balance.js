...
// functions/get-balance.ts
var get_balance_exports = {};
__export(get_balance_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_balance_exports);
...
var handler = async (event, context) => {
  ...
  try {
    ...
    console.log("\u{1F4E6} Account balance data:", response);
    return {
      statusCode: 200,
